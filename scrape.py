...
urls = ["https://finance.yahoo.com/quote/GOOGL?p=GOOGL&.tsrc=fin-srch","https://finance.yahoo.com/quote/AMZN?p=AMZN&.tsrc=fin-srch","https://finance.yahoo.com/quote/MSFT?p=MSFT&.tsrc=fin-srch"]
...
for url in urls:
    ...
    for i in range(0,8):
        ...
        price = table_info[i].find_all("td")[1].get_text()
        # print(heading+ " : " + price)
        stock.append(price)
    time.sleep(5)
